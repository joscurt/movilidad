 ...
 */
	Configure::write('Security.salt', 'DY123hG93b0qy2JfIx222fs20303guVoUubW4wvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '768593090303231123123657465354249674549683645');
...
// Configure::write('Session.timeout', '20');  // Descomentar para 20 min de timeout
