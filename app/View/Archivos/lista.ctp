  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?php echo $this->Html->url(array('action'=>'cargarArchivos')) ?>" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <div class="input-group input-file" name="data[Image][submittedfile]">
	...
	$(".input-file").before(
		function() {
			if ( ! $(this).prev().hasClass('input-ghost') ) {
				var element = $("<input type='file' name='data[Image][submittedfile]' class='input-ghost' style='visibility:hidden; height:0'>");
